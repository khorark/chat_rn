 ...
 */
export const getValueFromStorage = async (valueName: string) => AsyncStorage.getItem(valueName)
 ...
 */
export const setValueToStorage = async (valueName: string, value: string) => AsyncStorage.setItem(valueName, value)
